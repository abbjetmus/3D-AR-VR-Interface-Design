...
### 3D
**3D**, en förkortning för tredimensionell, är det rumsperspektiv där längd, bredd och djup uppfattas. Med tredimensionell, menas att ett objekt eller en matematisk figur har tre dimensioner, som är ett område i höjd, bredd och djup. Därmed har tredimensionella kroppar en volym.<br><br>
